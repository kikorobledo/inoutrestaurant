<div class="">
    ...
    <div class="mb-5">
        ...
        <h1 class="titulo-seccion text-3xl font-thin text-gray-500 mb-5">Clientes</h1>

        <div>

            <input type="text" wire:model="search" placeholder="Buscar" class="bg-white rounded-full text-sm">

            <button wire:click="openModalCreate" class="bg-gray-500 hover:shadow-lg hover:bg-gray-700 float-right mb-5 text-sm py-2 px-4 text-white rounded-full focus:outline-none hidden md:block">Agregar Nuevo Cliente</button>
                        ...
                        @if(auth()->user()->roles[0]->name != 'Empleado')
                            <td class="px-6 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b lg:table-cell relative lg:static">
                                ...
                                <div class="flex justify-center lg:justify-start">
                                    ...
                                    <button wire:click="openModalEdit({{$client}})" class="bg-blue-400 hover:shadow-lg text-white text-xs md:text-sm px-3 py-2 rounded-full mr-2 hover:bg-blue-700 flex focus:outline-none">
                                    ...
                                    @if(auth()->user()->roles[0]->name != 'Empleado Especial')
                                        <button wire:click="openModalDelete({{$client}})" class="bg-red-400 hover:shadow-lg text-white text-xs md:text-sm px-3 py-2 rounded-full hover:bg-red-700 flex focus:outline-none">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4 mr-3">
